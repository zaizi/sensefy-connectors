...
public class OpenNlpExtractorConfig
{
    ...
    public static final String NODE_EXTRACT_NOUNS = "ExtractNouns";
    public static final String NODE_EXTRACT_VERBS = "ExtractVerbs";
    ...
    private static final String POS_TAGGER_BIN = "resources/nlpmodels/en-pos-maxent.bin";
    ...
    public static final POSTagger posTagger() throws InvalidFormatException, FileNotFoundException, IOException{
        return new POSTaggerME(new POSModel(new FileInputStream(POS_TAGGER_BIN)));
    }
