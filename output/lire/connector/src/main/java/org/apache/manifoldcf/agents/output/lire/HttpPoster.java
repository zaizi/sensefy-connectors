    ...
    try
    {
      ...
      try
      {
        ...
        if (t.getActivityCode() != null)
          activities.recordActivity(t.getActivityStart(),LireConnector.INGEST_ACTIVITY,t.getActivityBytes(),documentURI,t.getActivityCode(),t.getActivityDetails());
    ...
    throws ManifoldCFException, ServiceInterruption
  {
    ...
    try
    {
      ...
      try
      {
        ...
        if (t.getActivityCode() != null)
          activities.recordActivity(t.getActivityStart(),LireConnector.REMOVE_ACTIVITY,null,documentURI,t.getActivityCode(),t.getActivityDetails());
